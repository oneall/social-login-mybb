...
function oa_social_login_info()
{
    return [
        ...
        'description' => 'Allow your visitors to comment, login and register with 40+ Social Networks like Twitter / X, TikTok, Facebook, LinkedIn, Instagram, Вконтакте, Google or Yahoo.',
