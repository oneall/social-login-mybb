...
$oa_settings = [
    ...
    'enable_display' => [
        'optionscode' => 'php
    <p>
       <legend>' . $lang->setting_oa_social_login_enable_display . '</legend>
    </p>'
    ],
    'enabled' => [
        'title' => $lang->setting_oa_social_login_enable,
        'description' => $lang->setting_oa_social_login_enable_desc,
        'value' => '1'
    ],
    ...
    'link_display' => [
        'optionscode' => 'php
    <p>
       <legend>' . $lang->setting_oa_social_login_link_display . '</legend>
    </p>'
    ],
